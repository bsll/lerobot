...
USB_PORTS["1-4.2:1.0"]="can_leader:1000000"
USB_PORTS["1-4.1:1.0"]="can_follower:1000000"
...
# Step 1: Print USB_PORTS mapping and check for duplicate target CAN names
...
for k in "${!USB_PORTS[@]}"; do
    ...
    # Check for duplicate target CAN names
